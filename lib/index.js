...
function getEntries(feedConfig, url) {
  ...
  var timeoutCallback = feedConfig.timeoutCallback || function (feedConfig, url) {}

  req.setMaxListeners(50);
  req.setTimeout(timeout, function() { timeoutCallback(feedConfig, url) });
